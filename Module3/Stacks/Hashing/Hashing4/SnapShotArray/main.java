...
public class Main
{
	...
	{
		if(mapArray[index]==null)mapArray[index]=new HashMap<Integer,Integer>();
	...
	{
		if(mapArray[index]==null)return 0;
		while(snap_id>=0 && mapArray[index].containsKey(snap_id)==false)snap_id--;
