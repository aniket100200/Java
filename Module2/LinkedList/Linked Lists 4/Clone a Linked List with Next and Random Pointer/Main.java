...
class Solution {
    ...
    Node copyList(Node head)
	{
		...
		{
			Node curr=temp.next;
			Node newNode=new Node(temp.data);		temp.next=newNode;
			newNode.next=curr;
			temp=curr;
			
		}
		//successfully copied the Node of the linked list...
		//Now go for random pointers..
		Node curr=head;
		while(curr!=null)
		{
			if(curr.random==null)
		...
		//copied random pointers... successfully..
		//restore original copied linkedlist..
		Node original=head;
		Node copy=head.next;
		temp=copy;
		while(original!=null)
